  ...
  const pickImage = async () => {
    try {
      ...
      if (Platform.OS !== "web") {
        ...
        if (status !== "granted") {
          Alert.alert("Sorry, we need camera roll permissions to access your photos.");
          return;
        }
            ...
            <TouchableOpacity style={styles.button} onPress={handleSubmit} disabled={isLoading}>
              {
                isLoading? (
                  ...
                  <>
                  <Ionicons name="cloud-upload-outline" size={24} color={COLORS.white} style={styles.buttonIcon} />
